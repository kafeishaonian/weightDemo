...
public class DraggablePresenterImpl implements DraggablePresenter, SquareDragView.Listener {
    ...
    public DraggablePresenterImpl(@NonNull Activity activity, @NonNull SquareDragView dragSquare) {
    ...
    public DraggablePresenterImpl(@NonNull Fragment fragment, @NonNull SquareDragView dragSquare) {
