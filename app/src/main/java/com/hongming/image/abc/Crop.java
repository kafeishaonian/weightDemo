...
import com.example.myapplication.CropImageActivity;
import com.example.myapplication.CropUtil;
...
public class Crop {
     ...
     * @param fragment Fragment to receive result
     */
    public static void takePhoto(Context context, androidx.fragment.app.Fragment fragment) {
        takePhoto(context, fragment, REQUEST_PHOTO);
    }
...
//        Toast.makeText(context, R.string.crop__pick_error, Toast.LENGTH_SHORT).show();
     ...
     * @param requestCode requestCode for result
     */
    public static void takePhoto(Context context, androidx.fragment.app.Fragment fragment, int requestCode) {
        try {
            fragment.startActivityForResult(getTakePhoto(), requestCode);
        } catch (ActivityNotFoundException e) {
